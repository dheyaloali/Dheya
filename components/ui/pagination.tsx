...
const PaginationFirst = ({ className, ...props }: React.ComponentProps<typeof PaginationLink>) => (
  <PaginationLink aria-label="Go to first page" size="default" className={cn("gap-1 px-3", className)} {...props}>
    <span>First</span>
  </PaginationLink>
)
...
const PaginationLast = ({ className, ...props }: React.ComponentProps<typeof PaginationLink>) => (
  <PaginationLink aria-label="Go to last page" size="default" className={cn("gap-1 px-3", className)} {...props}>
    <span>Last</span>
  </PaginationLink>
)
